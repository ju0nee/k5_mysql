...
CREATE TABLE `dept` (
  ...
  `dname` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  `budget` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`dno`)
...
INSERT INTO `dept` VALUES ('D1','Marketing','10M'),('D2','Development','12M'),('D3','Research','5M');
...
CREATE TABLE `emp` (
  ...
  `ename` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL,
  `dno` char(4) COLLATE utf8mb3_unicode_ci NOT NULL,
  `salary` char(4) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`eno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `emp` VALUES ('E1','Lopez','D1','40K'),('E2','Cheng','D1','42K'),('E3','Rinzi','D2','30K'),('E4','Saito','D2','35K');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `j` (
  `jno` varchar(4) COLLATE utf8mb3_unicode_ci NOT NULL,
  `jname` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
...
INSERT INTO `s` VALUES ('S1','Smith',20,'London'),('S2','Jones',10,'Paris'),('S3','Blake',30,'Paris'),('S4','Clark',20,'London'),('S5','Admas',30,'Athens');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `spj` (
  `sno` varchar(45) COLLATE utf8mb3_unicode_ci NOT NULL,
  `pno` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `jno` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `qty` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
-- Dump completed on 2023-11-13 12:48:01
